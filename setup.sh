...
echo "============================================"
echo "  无需 App 即可测试:"
echo "    ✅ list_examples          - 列出 4 个示例规则"
echo "    ✅ get_example_rule       - 读取示例规则（河马/云帧享/聚阅/青豆）"
echo "    ✅ get_rule_docs          - 获取写源说明 / SKILL / hiker.d.ts"
echo "    ✅ format_rule_code       - 格式化规则代码"
echo "    ✅ format_js_code         - 格式化 JS 插件代码"
...
echo "    ✅ list_js_plugins        - 列出 JS 插件（需连接）"
echo "    ✅ get_js_plugin          - 读取 JS 插件（需连接）"
echo "    ✅ save_js_plugin         - 保存 JS 插件（需连接）"
echo ""
echo "🎉 现在可以开始使用了！"